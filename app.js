...
app.set("view engine", "ejs"); //it will lokk files into views folder


//middleware for sttiac files
...
//createing a new hanler addd-blog to add a blog to the collection
//mongoose and mongo sandbox routes

app.get("/", (req, res) => {//home page will redirect to blogs
  res.redirect('/blogs')
  });
...
Blog.find().sort({createdAt: -1})//sort acc to newest to oldest
.then((result)=>{
...
app.post('/blogs',(req,res)=>{//you can now access request body that contain all the information we need from the webform let me just log this to the console so i can show you request body
